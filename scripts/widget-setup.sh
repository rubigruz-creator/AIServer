...
echo ""
echo "6) Установка на сайты — один snippet для всех (перед </body>):"
echo "   см. embed/snippet.html и .docs/WIDGET-SITES.md"
echo "   Сайты в CSP: gortruck.ru, service-ref.ru, refmontaj.ru,"
echo "   ons.remont-gazon.ru, remont-gazon.ru"
echo ""
echo "7) Intake admin: https://agent.remont-gazon.ru/intake/admin"
echo ""
