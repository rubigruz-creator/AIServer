...
echo "  3) Snippet для сайтов (один код): embed/snippet.html — см. .docs/WIDGET-SITES.md"
echo "     Домены в CSP: gortruck.ru, service-ref.ru, refmontaj.ru, remont-gazon.ru, ons"
